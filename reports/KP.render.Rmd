...
```{r}
plot_performance(results[results$node_selection_rule != "breadth-first" & (results$heuristic != "-" | results$solver == "external"),], column_solver = "solver_with_params")
```

## Node selection strategies

```{r}
results_node_selection_strategies = results[results$solver == "bab" & results$branching_rule == "most-infeasible" & results$heuristic == "simple-rounding",]
```
